...
//사각형을 만들어야 한다는 조건이 너무 어렵다. -> 어떤 방법이 있을까
//사각형을 굳이 8방향 다 돌아야만 할까?? 다른 방법은 뭐가 있을까(한 방향으로만 돌아도 된다.)
//왜 result에 4보다 작은 값이 들어갈까? length가 3이상일때만 update를 하도록 만들어 놨는데.....
//visited랑 dsst의 역할을 합할 수 있다.
public class 디저트카페 {
